<template>
  <router-link :to="`/todo-list/${ props.id }`" class="card">
    <span class="mark center">
    ...
    <span class="body">
      <ul class="list">
        <li class="list-item completed">Carrot</li>
        <li class="list-item">Milk</li>
        <li class="list-item">Sausage</li>
      </ul>
